...
<!--navbar navbar-default navbar-custom-->
    ...
    <div class="container">
      <center><h1><bold>SELAMAT DATANG DI WEBSITE SPK PENERIMAAN BEASISWA PENINGKATAN PRESTASI AKADEMIK (PPA)</bold></h1></center>
    </div>
    ...
    <!-- <footer class="text-center">
      <div class="footer-below">
        <div class="container">
          <div class="row">
            <div class="col-lg-12">
              <em>Sistem Pendukung Keputusan Pemilihan Penerima Beasiswa Dengans Metode Topsis</em>
            </div>
          </div>
        </div>
      </div>
