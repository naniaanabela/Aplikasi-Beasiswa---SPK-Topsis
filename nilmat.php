          ...
          <div class="col-lg-12">
            <div class="panel panel-default">
              <div class="panel-heading text-center">
                Tabel Alternatif & Tabel Kriteria
                  </div>  
    ...
    <div class="container">
        ...
        <!--tabel penentuan nilai-->
                ...
                <div class="panel-body">
                  <table class="table table-striped table-bordered table-hover">
                    ...
                    <tbody>
                      ...
                      <tr>
                        <td>1.00.001 - 2.500.000</td>
                        <td>4</td>
                      </tr>
                      <tr>
                        <td>2.500.001 - 4.000.000 </td>
                        <td>3</td>
                      </tr>
                      <tr>
                        <td>> 4.000.000 </td>
          ...
          <div class="col-xs-6 col-md-4">
                  <div class="panel panel-default">
                <div class="panel-heading text-center">
                  Prestasi Non-Akd & Kemampuan B. Asing [C4&C5]
                </div>
                <div class="panel-body">
                  <table class="table table-striped table-bordered table-hover">
                    <thead>
        ...
        <footer class="text-center">
          <div class="footer-below">
            <div class="container">
              <div class="row">
                <div class="col-lg-12">
              <em>Sistem Pendukung Keputusan Pemilihan Penerima Beasiswa PPA Dengan Metode Topsis</em>
                </div>
              </div>
            </div>
          </div>
